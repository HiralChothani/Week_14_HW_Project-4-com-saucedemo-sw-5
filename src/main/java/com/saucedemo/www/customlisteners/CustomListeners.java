package com.saucedemo.www.customlisteners;
...
import static com.saucedemo.www.utility.Utility.takeScreenShot;
...
public class CustomListeners implements ITestListener {
    ...
    @Override
    public void onStart(ITestContext iTestContext) { // initialization of report
        reporter = new ExtentSparkReporter(System.getProperty("user.dir")+"/test-output/extent.html");
        reporter.config().setDocumentTitle("Automation Report");
        reporter.config().setReportName("saucedemo"); // project name
